...
CREATE TABLE areas (
 id INT NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (id),
    ...
    REFERENCES sistema_reclamos (id))
ENGINE = InnoDB;
...
CREATE TABLE empleados (
 id INT NOT NULL AUTO_INCREMENT,
  ...
  estado CHAR(1) NOT NULL,
  PRIMARY KEY (id),
  FOREIGN KEY (id_tipo) REFERENCES tipo_empleados(id),
  FOREIGN KEY (id_sistema) REFERENCES sistema_reclamos(id),
      FOREIGN KEY (id_area)
    REFERENCES areas (id))
ENGINE = InnoDB;
...
CREATE TABLE asignaciones (
 id INT NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (id),
    FOREIGN KEY (id_conf)
    REFERENCES reclamo_confirmados (id),
