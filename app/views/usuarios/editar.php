...
<div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form  action="<?php echo RUTA_URL ?>/usuarios/editar/<?php echo $datos['id'];?>" id="formulario_usuarios" method="POST" enctype="multipart/form-data" >
                <div class="card-body">
                ...
                <select class="form-control select2" name="id_persona" id="id_persona" style="width: 100%;"  value="<?php echo $datos['id_persona']?>">
                  <option selected="selected" ><?php echo $datos['id_persona']?></option>
...
<?php endforeach; ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" name="clave" class="form-control" id="clave" value="<?php echo $datos['clave'];?>" placeholder="clave">
                  </div>
