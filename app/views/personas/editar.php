...
<div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form  action="<?php echo RUTA_URL ?>/personas/editar" id="formulario_personas" method="POST" enctype="multipart/form-data" >
                <div class="card-body">
                <div class="row">
              ...
              <div class="form-group">
                ...
                <input type="submit" class="btn btn-primary" value="editar">                  <a href="<?php echo RUTA_URL?>/personas" class="btn btn-dark ">Cancelar</a> 
